...
%g_x0 = x1^2/(1.5^2) + x2^2/(1.5*97^2) + x3^2/(0.3^2) + x4^2/(110^2) + x5^2/(0.01^2)  ; % = 1
...
prog = sossetobj(prog,coeff_1*10 + coeff_3/(97^2) + coeff_6*100 + coeff_10*10 + coeff_15); %Minimise Tr(Q) = q1 + q3
